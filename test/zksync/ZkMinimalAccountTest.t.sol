...
import {BOOTLOADER_FORMAL_ADDRESS} from "cyfrin-foundry-era-contracts/Constants.sol";
import {ACCOUNT_VALIDATION_SUCCESS_MAGIC} from "cyfrin-foundry-era-contracts/interfaces/IAccount.sol";
...
contract ZkMinimalAccountTest is Test, ZkSyncChainChecker {
    ...
    uint8 constant ACCOUNT_ABSTRACTION_TYPE = 113;
    ...
    function testZkOwnerCanExecuteCommands() public {
        ...
        Transaction memory transaction =
            _createUnsignedTransaction(minimalAccount.owner(), ACCOUNT_ABSTRACTION_TYPE, dest, value, functionData);
